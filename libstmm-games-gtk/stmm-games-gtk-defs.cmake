...
set(STMM_GAMES_GTK_MINOR_VERSION 23) # !-U-!
...
set(STMM_GAMES_GTK_REQ_STMM_GAMES_FILE_MINOR_VERSION 23) # !-U-!
...
set(STMM_GAMES_GTK_REQ_STMM_INPUT_GTK_MINOR_VERSION 13) # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-games-gtk)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-games-gtk SHARED IMPORTED)
#     else()
#         add_library(stmm-games-gtk STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-games-gtk PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-games-gtk PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMGAMESGTK_INCLUDE_DIRS}")
...
#     list(APPEND STMMI_TEMP_PROPS ${STMMINPUTGTK_LIBRARIES})
#     list(APPEND STMMI_TEMP_PROPS ${GTKMM_LIBRARIES})
#     list(APPEND STMMI_TEMP_PROPS ${LIBRSVG_LIBRARIES})
#     set_target_properties(stmm-games-gtk PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMI_TEMP_PROPS}")
# endif()
