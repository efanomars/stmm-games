...
//static const std::string s_sLevelBoardOverlaysTilesDefaultTileNodeName = "DefaultTile";
//static const std::string s_sLevelBoardOverlaysTilesTileNodeName = "Tile";
//static const std::string s_sLevelBoardOverlaysTilesTileIdAttr = "idChar";
