...
# File:   uninstall_stmm-games-all.py

# Removes all files installed by the install_stmm-games-all.sh script.
...
def main():
	import argparse
	oParser = argparse.ArgumentParser("Removes all files created by install_stmm-games-all.py")
	...
	subprocess.check_call("./libstmm-games-xml-gtk/scripts/uninstall_libstmm-games-xml-gtk.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-games-xml-game/scripts/uninstall_libstmm-games-xml-game.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-games-xml-base/scripts/uninstall_libstmm-games-xml-base.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-games-gtk/scripts/uninstall_libstmm-games-gtk.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-games-file/scripts/uninstall_libstmm-games-file.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-games-fake/scripts/uninstall_libstmm-games-fake.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-games/scripts/uninstall_libstmm-games.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())
