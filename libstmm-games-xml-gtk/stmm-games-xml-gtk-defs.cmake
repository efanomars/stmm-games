...
set(STMM_GAMES_XML_GTK_MINOR_VERSION 31) # !-U-!
...
set(STMM_GAMES_XML_GTK_REQ_STMM_GAMES_GTK_MINOR_VERSION 31) # !-U-!
...
set(STMM_GAMES_XML_GTK_REQ_STMM_GAMES_XML_GAME_MINOR_VERSION 31) # !-U-!
...
# required libfontconfig1 version
set(STMM_GAMES_XML_GTK_REQ_FONTCONFIG_VERSION "2.11.0")
...
if ("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "")
    ...
    pkg_check_modules(FONTCONFIG       REQUIRED  fontconfig>=${STMM_GAMES_XML_GTK_REQ_FONTCONFIG_VERSION})
endif()
...
list(APPEND STMMGAMESXMLGTK_EXTRA_INCLUDE_SDIRS "${FONTCONFIG_INCLUDE_DIRS}")
...
list(APPEND STMMI_TEMP_EXTERNAL_LIBRARIES       "${FONTCONFIG_LIBRARIES}")
