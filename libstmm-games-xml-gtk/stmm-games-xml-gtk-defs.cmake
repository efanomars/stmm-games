# File: libstmm-games-xml-gtk/stmm-games-xml-gtk-defs.cmake
...
set(STMM_GAMES_XML_GTK_MINOR_VERSION 24) # !-U-!
...
set(STMM_GAMES_XML_GTK_REQ_STMM_GAMES_GTK_MINOR_VERSION 24) # !-U-!
...
set(STMM_GAMES_XML_GTK_REQ_STMM_GAMES_XML_GAME_MINOR_VERSION 24) # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-games-xml-gtk)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-games-xml-gtk SHARED IMPORTED)
#     else()
#         add_library(stmm-games-xml-gtk STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-games-xml-gtk PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-games-xml-gtk PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMGAMESXMLGTK_INCLUDE_DIRS}")
...
#     list(APPEND STMMI_TEMP_PROPS "stmm-games-gtk")
#     list(APPEND STMMI_TEMP_PROPS "stmm-games-xml-game")
#     set_target_properties(stmm-games-xml-gtk PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMI_TEMP_PROPS}")
# endif()
