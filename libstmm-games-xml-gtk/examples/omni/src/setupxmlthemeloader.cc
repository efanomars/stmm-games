...
#include <stmm-games-xml-gtk/xmlmodifierparser.h>
#include <stmm-games-xml-gtk/xmlthanimationfactoryparser.h>
#include <stmm-games-xml-gtk/xmlthwidgetfactoryparser.h>
...
void omniSetupXmlThemeLoader(unique_ptr<XmlThemeLoader>& refXmlThemeLoader
