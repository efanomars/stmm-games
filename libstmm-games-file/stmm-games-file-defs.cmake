...
set(STMM_GAMES_FILE_MINOR_VERSION 23) # !-U-!
...
set(STMM_GAMES_FILE_REQ_STMM_GAMES_MINOR_VERSION 23) # !-U-!
...
#if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-games-file)
#    if (BUILD_SHARED_LIBS)
#        add_library(stmm-games-file SHARED IMPORTED)
#    else()
#        add_library(stmm-games-file STATIC IMPORTED)
#    endif()
#    set_target_properties(stmm-games-file PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#    set_target_properties(stmm-games-file PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMGAMESFILE_INCLUDE_DIRS}")
...
#    set_target_properties(stmm-games-file PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMI_TEMP_PROPS}")
#endif()
